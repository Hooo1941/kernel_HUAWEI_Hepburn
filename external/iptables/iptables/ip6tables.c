	     ...
	     struct xtc_handle *handle)
{
	...
	if (count != 0) {
		ALOGI("append_entry, print v6 firewall, count:%d", count);
	}
	return ret;
}
	      ...
	      struct xtc_handle *handle)
{
	...
	if (verbose) {
		print_firewall_line(fw, handle);
		ALOGI("replace_entry, print v6 firewall");
	}
	     ...
	     struct xtc_handle *handle)
{
	...
	if (count != 0) {
		ALOGI("insert_entry, print v6 firewall, count:%d", count);
	}
	return ret;
}
	     ...
	     const struct xtables_target *target)
{
	...
	if (count != 0) {
		ALOGI("delete_entry, print v6 firewall, count:%d", count);
	}
	return ret;
}
	    ...
	    const struct xtables_target *target)
{
	...
	if (count != 0) {
		ALOGI("check_entry, print v6 firewall, count:%d", count);
	}
	return ret;
}
