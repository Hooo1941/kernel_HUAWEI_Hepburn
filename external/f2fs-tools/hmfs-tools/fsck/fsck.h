...
extern int fsck_chk_didnode_blk(struct f2fs_sb_info *, struct f2fs_inode *,
		enum FILE_TYPE, struct f2fs_node *, u32 *, struct child_info *,
		struct dnode_of_data *);
extern int fsck_chk_data_blk(struct f2fs_sb_info *, int, u32, struct child_info *,
		int, enum FILE_TYPE, u32, u16, u8, int, struct dnode_of_data *);
extern int fsck_chk_dentry_blk(struct f2fs_sb_info *, int,
		u32, struct child_info *, int, int, struct dnode_of_data *);
...
extern void flush_nat_entries(struct f2fs_sb_info *);
